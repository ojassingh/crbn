    ...
    <>
      ...
      <div className='flex justify-between'>
        ...
        <div className='w-1/2 pr-10'>
          ...
          <p className="font-semibold text-3xl">Impact</p>
          ...
          <a
                  href="#"
                  className="flex w-1/2 mb-10 first-line:items-center justify-center rounded-md border border-transparent bg-navBarBg px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
                >
            Add to bag
          </a>
          <hr className="py-3" />
          <p className="font-medium text-xl mb-3 text-navBarBg">
            Features          
          </p>
          <ul className="font-light text-gray-600 text-md">
